const Movies = [
...

  {
    title: "Jurassic Park",
    description:
      "The story is about Jurassic Park, a nature reserve on a remote South American island owned by billionaire businessman John Hammond. Hammond and his team of dedicated scientists have populated the park with genetically engineered dinosaurs.",
    posterURL:
...

  {
    title: "The Godfather",
    description:
      "The story of the powerful Italian-American crime family, the Corleones. Filled with themes of loyalty, betrayal, and power.",
    posterURL:
...

  {
    ...
    description:
      "It is the first year of Germany's occupation of France. Allied officer Lt. Aldo Raine assembles a team of Jewish soldiers to commit violent acts of retribution against the Nazis.",
    posterURL:
...

  {
    ...
    description:
      "With the help of allies Lt. Jim Gordon and DA Harvey Dent, Batman has been able to keep a tight lid on crime in Gotham City until the appearance of the chaotic Joker.",
    posterURL:
...

  {
    ...
    description:
      "Frank Abagnale, a 17 years old master of deception become the most successful forger and bank robber whic hmakes him the top priority of FBI agent Carl Hanratty.",
    posterURL:
